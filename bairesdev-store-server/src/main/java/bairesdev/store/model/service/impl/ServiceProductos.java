...
public class ServiceProductos implements IServiceProductos {
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#getProductos()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#getCategorias()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#getMedidas()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#getProductoPorId(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#getCategoriaPorId(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#getMedidaPorId(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#incluirProducto(bairesdev.store.model.entity.Producto)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#modificarProducto(bairesdev.store.model.entity.Producto)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see bairesdev.store.model.service.IServiceProductos#eliminarProducto(java.lang.Integer)
	 */
	@Override
