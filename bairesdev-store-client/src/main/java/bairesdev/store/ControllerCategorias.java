...
public class ControllerCategorias {
		...
		if (categoria != null &&  
			...
			try {
				ResponseEntity<Categoria> result = restTemplate.exchange(
						"http://localhost:8080/bairesdev-store-server/store/categorias/incluir", 
	...
	public String modificar(@ModelAttribute("categoria") Categoria categoria, @RequestParam(value="idString",  required=true) String idString) {
		if (categoria != null &&  
			...
			try {
				ResponseEntity<Categoria> result = restTemplate.exchange(
						"http://localhost:8080/bairesdev-store-server/store/categorias/modificar", 
	...
	public String eliminar(@PathVariable Integer id) {
		...
		ResponseEntity<String> result = restTemplate.exchange(
								"http://localhost:8080/bairesdev-store-server/store/categorias/eliminar/"+id, 
